...
<div class="container py-5 h-100 col-4">
    ...
    <form method="post" action="/api/v1/project/template/create" style="padding-top: 10px;">
        <!-- Email input -->
        ...
        <div class="form-outline mb-4">
            <select class="form-select" aria-label="Default select example" name="templateId">
